<?php
if(!class_exists('AccessPress_StorePro_Demo_Welcome')) :

	class AccessPress_StorePro_Demo_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					'getting_started' => esc_html__('Getting Started', 'storevilla-pro'),
					'actions_required' => esc_html__('Required Plugins', 'storevilla-pro'),
					'recommended_plugins' => esc_html__('Recommended Plugins', 'storevilla-pro'),
					'demo_import' => esc_html__('Import Demo', 'storevilla-pro'),
					'changelog' => esc_html__('ChangeLog', 'storevilla-pro'),
					'support' => esc_html__('Support', 'storevilla-pro'),
				);
			...
			public function welcome_admin_notice_display() {
				...
				if( is_admin() && ('themes.php' == $pagenow) && (isset($_GET['activated'])) ) {
					...
					<div class="updated apdemowelcome-an notice notice-success is-dismissible">
						<h2><?php printf(__( 'Welcome!', 'storevilla-pro' )) ?></h2>
						<p class="about-desc"><?php printf(esc_html__( 'Thank you for installing %1$s. It is now installed and ready to use. Here are some useful links to get started: ', 'storevilla-pro' ),$this->theme_name);  ?></p>
						<hr/>
						<div class="apdemowelcome-column-wrap">
							<div class="apdemowelcome-column col-img">
								<picture>
									<img src="<?php echo esc_url( get_template_directory_uri() . '/welcome/css/demos.gif' ); ?>">
								</picture>
							</div>
							<div class="apdemowelcome-column col-demos">
								<div>
									<h3>
										...
										<?php printf(__( 'Starter site demos!', 'storevilla-pro' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'You\'ve  got choices of great starter sites (Demos) to start with. By using one of these starter sites you\'ll get a great guidance on how to use the theme to its fullest and also save time to make your website. ', 'storevilla-pro' ), $this->theme_name, admin_url( 'themes.php?page=welcome-page#demo_import' )  ); ?></p>
								</div>
								<div>
									<div class="notice-btn-wrapper"><a class="nav-tab demo_import button" href="<?php echo admin_url( 'themes.php?page=welcome-page#demo_import' ) ?>"><?php esc_html_e( 'ready to use starter sites.', 'storevilla-pro' ); ?></a></div>

									<?php printf( wp_kses_post( '<a class="options-page-btn notice-info-btn" href="%2$s">Or start setting up your theme now (without demo)!</a>', 'storevilla-pro' ), $this->theme_name, admin_url( 'themes.php?page=welcome-page' )  ); ?>

									<p><?php esc_html_e( 'You can also reach-out to us for any support during the theme setup and use.', 'storevilla-pro' ); ?></p>
									<a href="https://accesspressthemes.com/support/" class=" ti-return-dashboard  button button-secondary  install-now" ><span><?php esc_html_e( 'Contact Support', 'storevilla-pro' ); ?></span></a>
							...
							<div class="apdemowelcome-column col-doc">
								<div>
									<h3>
										...
										<?php printf(__( 'Documentation', 'storevilla-pro' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'How to use %1$s! Here we\'ve a full and detailed documentation that explains how to use %1$s in its best. ', 'storevilla-pro' ), $this->theme_name ); ?></p>
									<a href="https://doc.accesspressthemes.com/storevillapro/" class=" button" ><span><?php esc_html_e( 'Full Documentation', 'storevilla-pro' ); ?></span></a>

								</div>
								<div class="apdemowelcome-doc-btn">
									<a href="#" class=" button" ><span><?php esc_html_e( 'Return to your Dashboard', 'storevilla-pro' ); ?></span></a>
								</div>
							</div>
						</div>
					</div>
			...
			public function welcome_register_menu() {
				...
				$welcome_menu_text = $this->theme_name.' '.esc_html__("Setup",'storevilla-pro' );
			...
			public function welcome_screen() {
				...
				<div class="wrap about-wrap access-wrap">
								...
								<div class="welcome-section-wrapper is_loading">
									...
									<div class="notice-sidebar is_loading">
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Join in our social networks!','storevilla-pro') ?></h4>
											<p><?php echo esc_html__('Get connected, share your opinions and more via our social community: ', 'storevilla-pro'); ?></p>

											<p><a href="https://www.facebook.com/AccessPressThemes"><?php echo esc_html('Join our Facebook Group','storevilla-pro') ?></a><?php echo esc_html__(' -to receive updates, offers and more.', 'storevilla-pro'); ?></p>

											<p><a href="https://www.youtube.com/channel/UCzD8I1moKISXDjAVr8dIf-w"><?php echo esc_html('Subscribe our YouTube Channel','storevilla-pro') ?></a><?php echo esc_html__(' -for tutorials, videos and more.', 'storevilla-pro'); ?></p>

											<p><a href="https://twitter.com/apthemes"><?php echo esc_html('Follow us on Twitter','storevilla-pro') ?></a><?php echo esc_html__(' -to stay updated. ', 'storevilla-pro'); ?></p>
										</div>
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Rate us!','storevilla-pro') ?></h4>
											<p><?php printf(esc_html__('Are you enjoying %1$s? We would love to hear your feedback!', 'storevilla-pro'),$this->theme_name); ?></p>
											<a href="https://wordpress.org/support/theme/storevilla/reviews/#new-post"><?php echo esc_html('Write a review','storevilla-pro') ?></a>
					...
					public function plugin_installer_callback(){
						...
						if ( ! current_user_can('install_plugins') ) {
							wp_die( esc_html__( 'Sorry, you are not allowed to install plugins on this site.', 'storevilla-pro' ) );
						}
				...
				// Check our nonce, if they don't match then bounce!
						if (! wp_verify_nonce( $nonce, 'plugin_installer_nonce' )) {
							wp_die( esc_html__( 'Error - unable to verify nonce, please try again.', 'storevilla-pro') );
						}
				...
				// Get Plugin Info
					...
					public function plugin_activation_callback() {
						...
						if(file_exists($plugin_file)) {
							...
							echo esc_html__('Plugin Does not Exists' , 'storevilla-pro');
						}
