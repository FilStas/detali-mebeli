...
<article id="post-<?php the_ID(); ?>" <?php post_class('storevilla-blog'); ?>>
	...
	<div class="sv-post-content">
		...
		<a href="<?php the_permalink(); ?>" class="sv-btn-countinuereading"><?php _e('countinue reading','storevilla-pro'); ?></a>
		
		<div class="sv-post-foot">
			<?php the_tags(''); ?>
			<div class="post-meta pull-right">
				<span class="sv-post-author"><?php _e('Post by :','storevilla-pro'); ?>
					<?php the_author_link(); ?>
				</span>
			</div>
		</div>
