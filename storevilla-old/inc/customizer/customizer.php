...
function storevilla_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section( 'storevilla_pro_demo_data_import_settings', array(
      'title'           =>      __('Import Demo Data', 'storevilla-pro'),
      'priority'        =>      1,
    ));

    $wp_customize->add_setting( 'storevilla_pro_demo_data_import', array(
      'default' =>  '1',
      //'sanitize_callback'     =>  'fotography_checkbox_sanitize'
    ));

    $wp_customize->add_control(new StoreVilla_Pro_WP_Customize_Demo_Control( $wp_customize, 'storevilla_pro_demo_data_import', array(
      'section'       =>      'storevilla_pro_demo_data_import_settings',
      'label'         =>      __('Import Demo Data', 'storevilla-pro'),
    )));
