...
if(class_exists( 'WP_Customize_control')) {
    ...
    */
    ...
    class StoreVilla_Pro_WP_Customize_Demo_Control extends WP_Customize_Control{            
        public function render_content() { ?>
            <label>
                <?php if ( ! empty( $this->label ) ) : ?>
                    <span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
                <?php endif; ?>
                <div class="">
                    <a href="#" id="demo_import"><?php _e('Import Demo','storevilla-pro'); ?></a>
                    <div class=""></div>
                    <div class="import-message"><?php _e('Click on Import Demo button to import demo contents.','storevilla-pro'); ?></div>
                </div>
            </label>
            <?php
        }
