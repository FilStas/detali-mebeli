<?php
add_action( 'wp_ajax_storevilla_pro_demo_import', 'my_action_callback' );
...
function my_action_callback(){
    ...
    if($importer_error){
        ...
        $import_filepath = get_template_directory() ."/inc/import/tmp/storevillapro.xml" ; // Get the xml file from directory 
