...
*/
require $storevilla_por_plugin_activation_php_file_path = storevilla_pro_file_directory('inc/storevilla-plugin-activation.php');
...
/**
 * Load StoreVilla Pro Impoter file
*/
require $storevilla_por_demo_data_import_php_file_path = storevilla_pro_file_directory('inc/import/ap-importer.php');
